...
# Must be set BEFORE loading plugins so zsh-nvm sees it
export NVM_DIR="$HOME/.nvm"
export NVM_AUTO_USE=true   # auto `nvm use` when .nvmrc is present

# Theme & OMZ plugins (include zsh-nvm; keep syntax-highlighting last)
ZSH_THEME="bira"
plugins=(
  git
  zsh-nvm
